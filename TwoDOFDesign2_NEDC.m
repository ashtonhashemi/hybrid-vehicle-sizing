...
[a,b] = contour( mot_map,eng_map, FuelMat',3.9:0.2:8,'linewidth',0.5,'LineColor','black');
...
title('Fuel economy [l/100km]/NEDC');

set(gcf,'PaperUnit','centimeters','PaperPosition',[0 0 9 6]);
print(gcf,'-dpng','-r300','NEDC');
PrintToImage(gcf, 'Figure 11-A', [9 6]);
