...
% h = waitbar(0,'calculating fuel consumption on grid');
% checkfeas = 0;
% for IM = 1:length(mot_map)
...
% end
[a,b] = contour( mot_map,eng_map, FuelMat',4.8:0.2:7,'linewidth',0.5,'LineColor','black');
...
set(gcf,'Color','white');
text(110,10,'Infeasible area');
title('Fuel economy [l/100km]/WLTC-Class 3');

set(gcf,'PaperUnit','centimeters','PaperPosition',[0 0 9 6]);
print(gcf,'-dpng','-r300','WLTC-Class 3');
PrintToImage(gcf, 'Figure 11-C', [9 6]);
